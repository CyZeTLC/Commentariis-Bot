...
public abstract class Command {
     ...
     */
    public void sendEmbedWithButtons(Embed embed, List<eu.cyzetlc.commentarii.service.button.Button> buttons) {
     ...
     * @param autoDelete If the message should be deleted after a certain amount of time.
     */
    public void sendEmbedWithButtons(Embed embed, List<eu.cyzetlc.commentarii.service.button.Button> buttons, boolean isReply, boolean autoDelete) {
        LinkedList<net.dv8tion.jda.api.interactions.components.buttons.Button> list = new LinkedList<>();
        for (eu.cyzetlc.commentarii.service.button.Button btn : buttons) {
